...
from core import DEFAULT_MODEL, ROOT_PATH, PARSED_JSONS_PATH, GROQ_KEY_PATH
from prompt_extraction import SYSTEM_PROMPT, build_user_message
...
def call_llama(acknowledgement_text: str, authors: list[str]):
    user_content = build_user_message(authors, acknowledgement_text)
