...
|---|---|---|---|---|
| groq/llama-3.3-70b-versatile | 0.9855 | 0.9200 | 1.0000 | 0.9635 |
| hf/Qwen/Qwen2.5-7B-Instruct | 0.7368 | 0.8511 | 0.8571 | 0.8000 |
| Jean-Baptiste/roberta-large-ner-english | 0.7143 | 0.6182 | 0.0000 | 0.6269 |
| kalawinka/flair-ner-acknowledgments | 0.8254 | 0.5778 | 1.0000 | 0.7619 |
...
|---|---|---|---|---|---|---|
| PER | 34 | 0 | 1 | 1.0000 | 0.9714 | 0.9855 |
| ORG | 23 | 2 | 2 | 0.9200 | 0.9200 | 0.9200 |
| PROJ | 9 | 0 | 0 | 1.0000 | 1.0000 | 1.0000 |
| **Overall** | 66 | 2 | 3 | 0.9706 | 0.9565 | 0.9635 |

### hf/Qwen/Qwen2.5-7B-Instruct

| Category | TP | FP | FN | Precision | Recall | F1 |
|---|---|---|---|---|---|---|
| PER | 21 | 1 | 14 | 0.9545 | 0.6000 | 0.7368 |
| ORG | 20 | 2 | 5 | 0.9091 | 0.8000 | 0.8511 |
| PROJ | 9 | 3 | 0 | 0.7500 | 1.0000 | 0.8571 |
| **Overall** | 50 | 6 | 19 | 0.8929 | 0.7246 | 0.8000 |

### Jean-Baptiste/roberta-large-ner-english

| Category | TP | FP | FN | Precision | Recall | F1 |
|---|---|---|---|---|---|---|
| PER | 25 | 10 | 10 | 0.7143 | 0.7143 | 0.7143 |
| ORG | 17 | 13 | 8 | 0.5667 | 0.6800 | 0.6182 |
| PROJ | 0 | 0 | 9 | 0.0000 | 0.0000 | 0.0000 |
| **Overall** | 42 | 23 | 27 | 0.6462 | 0.6087 | 0.6269 |

### kalawinka/flair-ner-acknowledgments

| Category | TP | FP | FN | Precision | Recall | F1 |
|---|---|---|---|---|---|---|
| PER | 26 | 2 | 9 | 0.9286 | 0.7429 | 0.8254 |
| ORG | 13 | 7 | 12 | 0.6500 | 0.5200 | 0.5778 |
| PROJ | 9 | 0 | 0 | 1.0000 | 1.0000 | 1.0000 |
| **Overall** | 48 | 9 | 21 | 0.8421 | 0.6957 | 0.7619 |

## Best model (by overall micro-averaged F1)

**groq/llama-3.3-70b-versatile** (Overall F1 = 0.9635)
